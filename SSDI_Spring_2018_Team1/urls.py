...
from beton.views import declare_winner, fetch_balance, dailybets, add_a_bet, options
from beton.views import post_edituserdetails, post_user_betdetails, post_makepayment, get_betstats, get_admincreatedtopics
...
urlpatterns = [
    ...
    url(r'^api/v1/makepayment/', post_makepayment, name='post_makepayment'),
    url(r'^api/v1/betstats/', get_betstats, name="get_betstats"),
    url(r'^api/v1/admincreatedtopics/', get_admincreatedtopics, name="get_admincreatedtopics"),
    ...
    url(r'^api/v1/options/$', options, name='options'),
    ...
    url(r'^api/v1/addbet/$', add_a_bet, name='add_a_bet'),
]
